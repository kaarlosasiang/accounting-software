                        ...
                        <CardContent className="space-y-6">
                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input id="lastName" placeholder="Accountant" defaultValue="Accountant" />
                                </div>
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="email">Email</Label>
                                <Input id="email" type="email" placeholder="john@rrd10.com" defaultValue="john@rrd10.com" />
                            </div>
                            <div className="space-y-2">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-sm text-muted-foreground">Get reminders for upcoming invoice due dates</p>
                                    </div>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <Input id="companyName" placeholder="RRD10 Accounting" defaultValue="RRD10 Accounting" />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="companyEmail">Company Email</Label>
                                <Input id="companyEmail" type="email" placeholder="contact@rrd10.com" />
                            </div>
                            <div className="grid gap-4 md:grid-cols-2">
                                <div className="space-y-2">
                                    <Label htmlFor="companyPhone">Company Phone</Label>
                                    <Input id="companyPhone" type="tel" placeholder="+1 (555) 000-0000" />
                                </div>
                                <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="website" type="url" placeholder="https://rrd10.com" />
                            </div>
                            <div className="space-y-2">
                            ...
                            <div className="flex items-center justify-between p-4 border rounded-lg">
                                <div className="space-y-1">
                                    ...
                                    <div className="flex items-center gap-2 mt-2">
                                        <Badge>Active</Badge>
                                        <span className="text-sm text-muted-foreground">Renews on Dec 20, 2025</span>
                                    </div>
                                </div>
                                    ...
                                    {[
                                        ...
                                        <div key={i} className="flex items-center justify-between p-3 border rounded-lg">
                                            <div>
                                                ...
                                                <p className="text-sm text-muted-foreground">Invoice #{2025001 - i}</p>
                                            </div>
                                            <div className="flex items-center gap-4">
