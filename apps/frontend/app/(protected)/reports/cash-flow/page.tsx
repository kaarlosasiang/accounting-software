        ...
        <div className="flex flex-col gap-6">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Detailed breakdown of cash movements across operating, investing, and financing activities
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="space-y-8">
                        ...
                        <div>
                            <h3 className="text-lg font-bold mb-4 text-blue-600">CASH FLOWS FROM OPERATING ACTIVITIES</h3>
                            <div className="ml-4">
                                <Table>
                                    <TableBody>
                        ...
                        <div className="pt-6 border-t">
                            <h3 className="text-lg font-bold mb-4 text-purple-600">CASH FLOWS FROM INVESTING ACTIVITIES</h3>
                            <div className="ml-4">
                                <Table>
                                    <TableBody>
                                        <TableRow className="hover:bg-muted/50">
                        ...
                        <div className="pt-6 border-t">
                            <h3 className="text-lg font-bold mb-4 text-orange-600">CASH FLOWS FROM FINANCING ACTIVITIES</h3>
                            <div className="ml-4">
                                <Table>
                                    <TableBody>
                                        <TableRow className="hover:bg-muted/50">
                        ...
                        <div className="pt-6 border-t">
                            <h4 className="text-sm font-semibold mb-3">SUPPLEMENTAL DISCLOSURES</h4>
            ...
            <div className="grid gap-4 md:grid-cols-3">
                <Card>
                    <CardHeader className="pb-3">
                        <CardTitle className="text-sm font-medium">Operating Cash Flow Ratio</CardTitle>
                    </CardHeader>
                    <CardContent>
