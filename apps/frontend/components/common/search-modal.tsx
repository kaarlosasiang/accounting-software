...
const NAV_LINKS = [
  ...
  { title: "Financial Analytics", url: "/dashboard/analytics", group: "Dashboard" },
  ...
  { title: "Liabilities", url: "/accounts/liabilities", group: "Chart of Accounts" },
  ...
  { title: "Create Invoice", url: "/invoices/create", group: "Sales & Receivables" },
  { title: "Customers", url: "/customers", group: "Sales & Receivables" },
  { title: "A/R Aging Report", url: "/reports/ar-aging", group: "Sales & Receivables" },
  // Purchases & Payables
  ...
  { title: "A/P Aging Report", url: "/reports/ap-aging", group: "Purchases & Payables" },
  // Cash Management
  { title: "All Payments", url: "/payments", group: "Cash Management" },
  { title: "Record Payment", url: "/payments/create", group: "Cash Management" },
  // General Ledger
  { title: "Ledger Entries", url: "/ledger", group: "General Ledger" },
  { title: "Journal Entries", url: "/journal-entries", group: "General Ledger" },
  { title: "Trial Balance", url: "/ledger?tab=trial-balance", group: "General Ledger" },
  // Inventory
  { title: "Items & Products", url: "/inventory", group: "Inventory" },
  { title: "Movement History", url: "/inventory/transactions", group: "Inventory" },
  // Financial Statements
  { title: "Profit & Loss", url: "/reports/profit-loss", group: "Financial Statements" },
  { title: "Balance Sheet", url: "/reports/balance-sheet", group: "Financial Statements" },
  { title: "Cash Flow Statement", url: "/reports/cash-flow", group: "Financial Statements" },
  { title: "Tax Summary", url: "/reports/tax-summary", group: "Financial Statements" },
  // Tax & Compliance
  { title: "VAT Returns", url: "/tax/vat", group: "Tax & Compliance" },
  { title: "Withholding Tax", url: "/tax/withholding", group: "Tax & Compliance" },
            ...
            <CommandGroup key={group} heading={group}>
              {items.map((item) => (
                <CommandItem
                  ...
                  onSelect={() => navigate({ title: item.title, url: item.url })}
                >
                  <span>{item.title}</span>
                  <span className="ml-auto max-w-32 truncate text-xs text-muted-foreground">
                    {item.url}
